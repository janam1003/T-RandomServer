...
public class tripInfoRESTClient {
    ...
    public <T> T findAllTripInfoByCustomer(Class<T> responseType, String mail) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("allByCustomer/{0}", new Object[]{mail}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T findInactiveTripInfoByCustomer(Class<T> responseType, String mail) throws ClientErrorException {
        WebTarget resource = webTarget;
    ...
    public <T> T findAllTripInfoByTrip(Class<T> responseType, String tripId) throws ClientErrorException {
        WebTarget resource = webTarget;
    ...
    public void delete(String customerId, String tripId) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("{0}/{1}", new Object[]{customerId, tripId})).request().delete(Trip.class);
    }

    public <T> T findActiveTripInfoByCustomer(Class<T> responseType, String mail) throws ClientErrorException {
        WebTarget resource = webTarget;
